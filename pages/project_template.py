...
def show_project_page(project_name):
    # 側邊欄設定
    st.sidebar.title('篩選控制')
    
    # 載入專案數據
    df = pd.read_csv(f'data/{project_name}/sample_qa_dashboard.csv')
...
if __name__ == '__main__':
    show_project_page("project_template")
